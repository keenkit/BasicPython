...
tinyMCE.init({
    ...
    language: "en",
    mode: "exact",
    elements: "inputComment",
    width: "80%",
    height: 600,
    theme: "advanced",
	//template,emotions,layer
    plugins: "lists,spellchecker,pagebreak,style,layer,table,save,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,insertcode,",//syntaxHighlighter,uploadImage,",
