        ...
        init: function (ed, url) {
            ...
            ed.addCommand('mceuploadImage', function () {
                ...
                ed.windowManager.open({
                        //file: 'http://upload.cnblogs.' + domainPostfix + '/ImageUploader/Upload?host=' + ed.documentBaseURI.host,
                        file: '/uploader/',
                        width: 600,
                        height: 400,
                        inline: 1
                }, {
                        plugin_url: url, some_custom_arg: ''
                });
            })
        ...
        */
        getInfo: function () {
            return {
                ...
                author: 'Will Hu',
                authorurl: 'http://www.BasicPython.com',
                infourl: 'http://www.BasicPython.com',
                version: "1.0"
            };
        }
    });
